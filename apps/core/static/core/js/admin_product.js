function doWork() {
    ...
    var variantTitleFieldEn = document.getElementsByClassName('field-variant_title_en').item(0)
    var variantTitleFieldFa = document.getElementsByClassName('field-variant_title_fa').item(0)
    ...
    function onHasVariantChange() {
        if (hasVariant.checked) {
            ...
            variantTitleFieldEn.style.display = 'block'
            variantTitleFieldFa.style.display = 'block'
            priceField.style.display = 'none'
        } else {
            variantSetGroup.style.display = 'none'
            variantTitleFieldEn.style.display = 'none'
            variantTitleFieldFa.style.display = 'none'
